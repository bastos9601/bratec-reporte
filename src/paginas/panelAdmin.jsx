          ...
          <form onSubmit={manejarCrearTecnico} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-3 pr-12 text-base border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors h-[42px]"
              />
              <button
                type="button"
